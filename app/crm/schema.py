...
class ContactPhoneType(DjangoObjectType):
    class Meta:
        model = ContactPhone


class ContactEmailType(DjangoObjectType):
    class Meta:
        model = ContactEmail
...
class Query(graphene.ObjectType):
    ...
    contactphone = graphene.List(ContactPhoneType)
    contactemail = graphene.List(ContactEmailType)
    ...
    @graphene.resolve_only_args
    def resolve_contactphone(self):
        return ContactPhone.objects.all()

    @graphene.resolve_only_args
    def resolve_contactphone(self):
        return ContactEmail.objects.all()
